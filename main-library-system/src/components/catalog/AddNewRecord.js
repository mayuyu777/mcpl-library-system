                                                        ...
                                                        item.subFields?.map((item,index)=>{
                                                            return(
                                                                <>
                                                                    ...
                                                                    { 
                                                                        !item?.options ? (item?.disable ? <textarea rows="1" cols="50" style={{fontSize:'12px'}} name={item.name} className='subfield-input' defaultValue={item.value} onChange={event => changeSubfieldInputVal(event,tabIndex,fieldIndex,index)} disabled/> 
                                                                                            : <textarea rows="1" cols="50"  style={{fontSize:'12px'}}  name={item.name} className='subfield-input' defaultValue={item.value} onChange={event => changeSubfieldInputVal(event,tabIndex,fieldIndex,index)}/> )
                                                                        : 
                                                                        <>
